...
#Sweave(paste(USEPATH, 'ds_functions_21JAN17.Rnw', sep='/') # D031517: not necessary when running app
...
@ 
<<label=load, echo=FALSE, eval=TRUE>>=
...
x227.df <- read.csv(paste(SERVERPROT, 'RawData/160621LDSSAM01867_227-2T6plx-FTK1-60_NOT_Normalized_PD22.csv', sep='/'))
x238.df <- read.table(paste(SERVERPROT, 'RawData/160816LDSSAM01867_238BT6plx-FTK1-60_NewDB.csv', sep='/'),
                   header=TRUE, quote='', sep='\t', fill=TRUE, comment.char='')
x239.df <- read.table(paste(SERVERPROT, 'RawData/160908LDSSAM01867_239T6plx-FTK1-60_UniprotHuman.csv', sep='/'),
                   header=TRUE, quote='', sep='\t', fill=TRUE, comment.char='')
x243.df <- read.table(paste(SERVERPROT, 'RawData/160922LDSSAM01867_243T6plx-FTK1-60_UniprotHuman2.csv', sep='/'),
                   header=TRUE, quote='', sep='\t', fill=TRUE, comment.char='')

write.table(x227.df, file=paste(SERVERPROT, 'TempData/x227.txt', sep='/'), quote=FALSE, sep='\t')
write.table(x238.df, file=paste(SERVERPROT, 'TempData/x238.txt', sep='/'), quote=FALSE, sep='\t')
write.table(x239.df, file=paste(SERVERPROT, 'TempData/x239.txt', sep='/'), quote=FALSE, sep='\t')
write.table(x243.df, file=paste(SERVERPROT, 'TempData/x243.txt', sep='/'), quote=FALSE, sep='\t')
...
# lookup files are:
# SERVERPROT/RawData/upAccession2GeneSymbol
# SERVERPROT/RawData/upAccession2upProtName

gs <- read.table(paste(SERVERPROT, 'RawData/upAccession2GeneSymbol', sep='/'), header=FALSE, sep='\t', quote='', fill=TRUE)
colnames(gs) <- NULL
pn <- read.table(paste(SERVERPROT, 'RawData/upAccession2upProtName', sep='/'), header=FALSE, sep='\t', quote='', fill=TRUE)
colnames(pn) <- NULL
...
gs <- read.table(paste(SERVERPROT, 'RawData/upAccession2GeneSymbol27383943', sep='/'), header=FALSE, sep='\t', quote='', fill=TRUE)
colnames(gs) <- NULL
...
# output of getProtAnnotUniprotv1.py in RawData/idAnnotWithUniProt
require(geneSynonym)
gs <- read.table(paste(SERVERPROT, 'RawData/idAnnotWithUniProt20FEB17', sep='/'), header=TRUE, sep='\t', quote='', fill=TRUE)
colnames(gs) <- NULL
...
write.table(gs[hasnosym,], file=paste(SERVERPROT, 'Python/protaccWithoutSymbol', sep='/') , quote=FALSE, sep='\t')
...
if (makegenehash) {# takes time! therefore save object so it needn't recreated every time it's used
    ...
    write.table(genealias.df, file=paste(SERVERPROT, 'Python/genealiases.txt', sep='/'), row.names=FALSE, quote=FALSE)
}
...
load(paste(SERVERPROT, 'genealias.rdat', sep='/'))
load(paste(SERVERPROT, 'upals.rdat', sep='/'))
...
# FGF signaling
fgf7.df <- read.table(paste(SERVERPROT, 'Pathways/string_fgf7.tsv', sep='/'), header=FALSE, quote='', sep='\t')
...
# Wnt signaling
gsk3beta.df <- read.table(paste(SERVERPROT, 'Pathways/string_gsk3b.tsv', sep='/'), header=FALSE, quote='', sep='\t')
...
rar.df <- read.table(paste(SERVERPROT, 'Pathways/rar.tsv', sep='/'), header=FALSE, quote='', sep='\t')
...
# TGFB signaling
tgfbeta.df <- read.table(paste(SERVERPROT, 'Pathways/tgfbeta.tsv', sep='/'), header=FALSE, quote='', sep='\t')
...
pdx1_gm <- read.table(paste(SERVERPROT, 'Pathways/gm_Pdx1.txt', sep='/'), header=TRUE, quote='', sep='\t')
...
activin_gm <- read.table(paste(SERVERPROT, 'Pathways/gm_Activin.txt', sep='/'), header=TRUE, quote='', sep='\t')
...
# D22317
# Shh signaling
shh.df <- read.table(paste(SERVERPROT, 'Pathways/string_shh.tsv', sep='/'), header=FALSE, quote='', sep='\t')
...
# D22717
# BMP signaling
bmp1.df <- read.table(paste(SERVERPROT, 'Pathways/string_bmp_1.tsv', sep='/'), header=FALSE, quote='', sep='\t')
sbmp1 <- unique(as.character(unlist(bmp1.df[,1:2])))
bmp2.df <- read.table(paste(SERVERPROT, 'Pathways/string_bmp_2.tsv', sep='/'), header=FALSE, quote='', sep='\t')
...
source(paste(SERVER, 'Sandbox/caret/R/normalize2Reference.R', sep='/'))
...
pdf(paste(SERVERPROT, 'Pdf/boxp_notNormTranfrm_12117.pdf', sep='/'))
...
pdf(paste(SERVER, 'Pres/Slides_27JAN17/vennProteinCoverage.pdf', sep='/'))
venn(prepVenn(TRUE))
dev.off()
...
pdf(paste(SERVER, 'Pres/Slides_27JAN17/parallelpHousekeeping227.pdf', sep='/'))
gplot_hkprots(log10(hk227.df), log10(dat227.df))
dev.off()
pdf(paste(SERVER, 'Pres/Slides_27JAN17/parallelpHousekeeping238.pdf', sep='/'))
gplot_hkprots(log10(hk238.df), log10(dat238.df))
dev.off()
pdf(paste(SERVER, 'Pres/Slides_27JAN17/parallelpHousekeeping239.pdf', sep='/'))
gplot_hkprots(log10(hk239.df), log10(dat239.df))
dev.off()
pdf(paste(SERVER, 'Pres/Slides_27JAN17/parallelpHousekeeping243.pdf', sep='/'))
...
set227 <- readMSnSet(exprsFile=paste(SERVERPROT, 'TempData/d227.csv', sep='/'), featureDataFile=paste(SERVERPROT, 'TempData/f227.csv', sep='/'),
                     phenoDataFile=paste(SERVERPROT, 'TempData/p227.csv', sep='/'), sep=',')
set238 <- readMSnSet(exprsFile=paste(SERVERPROT, 'TempData/d238.csv', sep='/'), featureDataFile=paste(SERVERPROT, 'TempData/f238.csv', sep='/'),
                     phenoDataFile=paste(SERVERPROT, 'TempData/p238.csv', sep='/'), sep=',')
set239 <- readMSnSet(exprsFile=paste(SERVERPROT, 'TempData/d239.csv', sep='/'), featureDataFile=paste(SERVERPROT, 'TempData/f239.csv', sep='/'),
                     phenoDataFile=paste(SERVERPROT, 'TempData/p239.csv', sep='/'), sep=',')
set243 <- readMSnSet(exprsFile=paste(SERVERPROT, 'TempData/d243.csv', sep='/'), featureDataFile=paste(SERVERPROT, 'TempData/f243.csv', sep='/'),
                     phenoDataFile=paste(SERVERPROT, 'TempData/p243.csv', sep='/'), sep=',')
...
write.table(adat227.df$features, paste(SERVERPROT, 'Python/f227', sep='/'), sep='\t', quote=FALSE, col.names=FALSE, row.names=FALSE)
write.table(adat238.df$features, paste(SERVERPROT, 'Python/f238', sep='/'), sep='\t', quote=FALSE, col.names=FALSE, row.names=FALSE)
write.table(adat239.df$features, paste(SERVERPROT, 'Python/f239', sep='/'), sep='\t', quote=FALSE, col.names=FALSE, row.names=FALSE)
write.table(adat243.df$features, paste(SERVERPROT, 'Python/f243', sep='/'), sep='\t', quote=FALSE, col.names=FALSE, row.names=FALSE)
...
# phenodata
p.df <- read.csv(paste(SERVERPROT, 'TempData/pData.txt', sep='/'))
...
if (FALSE) {
    pdf(paste(SERVER, 'Pres/Slides_27JAN17/boxpNotNormalized.pdf', sep='/'))
    print(.plot(xmss, 'All Samples Log Transformed  Not Normalized'))
    dev.off()

    mss <- imputeNormalizeTransform(mss)

    pdf(paste(SERVER, 'Pres/Slides_27JAN17/boxpNormalized.pdf', sep='/'))
...
pd <- read.table(paste(SERVERPROT, 'TempData/pData.txt', sep='/'), sep=',')
...
# phenodata
p273839.df <- read.csv(paste(SERVERPROT, 'TempData/pData273839.csv', sep='/'))
...
# ExpressionSet
pd <- read.csv(paste(SERVERPROT, 'TempData/pData273839.csv', sep='/'))
phenoData <- new('AnnotatedDataFrame', data=pd)
...
# phenodata
p273843.df <- read.csv(paste(SERVERPROT, 'TempData/pData273843.csv', sep='/'))
...
# ExpressionSet
pd <- read.csv(paste(SERVERPROT, 'TempData/pData273843.csv', sep='/'))
phenoData <- new('AnnotatedDataFrame', data=pd)
...
# phenodata
p273943.df <- read.csv(paste(SERVERPROT, 'TempData/pData273943.csv', sep='/'))
...
# ExpressionSet
pd <- read.csv(paste(SERVERPROT, 'TempData/pData273943.csv', sep='/'))
phenoData <- new('AnnotatedDataFrame', data=pd)
...
# phenodata
p383943.df <- read.csv(paste(SERVERPROT, 'TempData/pData383943.csv', sep='/'))
...
# ExpressionSet
pd <- read.csv(paste(SERVERPROT, 'TempData/pData383943.csv', sep='/'))
phenoData <- new('AnnotatedDataFrame', data=pd)
